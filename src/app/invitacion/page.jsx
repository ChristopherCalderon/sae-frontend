        ...
        >
          {loading ? (
            ...
            <div className="gap-3  flex flex-col  justify-center items-center">
              ...
              />
              <h1>Hola <a className="font-bold"> {data.name}</a> tu enlace de invitacion es el siguiente:</h1>
              ...
              <p>Enlace de invitacion: <a href={data.urlInvitation} className="underline hover:font-bold">{data.urlInvitation}</a> </p>
            </div>
          )}
        </div>
      </div>
